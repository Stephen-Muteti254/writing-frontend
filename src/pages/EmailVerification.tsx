...
const EmailVerification = () => {
  ...
  // Show verification UI only if email is not verified
        ...
        <CardContent className="space-y-6">
          <Alert className="border-warning/30 bg-warning/5">
            <AlertDescription className="text-base">
              Your email has not been verified. Check your inbox and click the link to activate your account.
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-3">
            <h3 className="font-semibold flex items-center gap-2">Didn't receive the email?</h3>
          ...
          <div className="pt-4 space-y-3">
            <Button className="w-full" size="lg" variant="default" onClick={handleResend}>
              Resend Verification Email
            </Button>
            <Button className="w-full" size="lg" variant="outline" onClick={handleUpdateEmail}>
